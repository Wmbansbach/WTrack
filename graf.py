...
def find_metrics():
    ...
    if not target or finder not in metric_finders:
        ...
        print(jsonify(metrics))
        return jsonify(metrics)
    else:
        print(jsonify(list(metric_finders[finder](target))))
...
if __name__ == '__main__':
    ...
    data_dir = os.path.join(os.environ[home_key],"_WTrack", "WTracker.csv")

    print(data_dir)
    dframe = pd.read_csv(data_dir)
    print(dframe)
    add_finder("Test", add_reader("Test", dframe))
